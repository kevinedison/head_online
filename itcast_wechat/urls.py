...
urlpatterns = [
	...
	#BBS urls
         url(r'^index1/$','wechat.views.bbsindex',name='index1'),
         url(r'^detail/(\d+)/$', 'wechat.views.bbs_detail',name='detail'),
         url(r'^sub_comment/$','wechat.views.sub_comment',name='sub_comment'),    
    	 url(r'^category/(\d+)/$','wechat.views.category',name='category'),	
    	 url(r'^accounts/login/$', 'django.contrib.auth.views.login',{'template_name': 'login.html'}), 
    	 url(r'^login/$', 'wechat.views.Login',name='login' ),
    	 url(r'^acc_login/$', 'wechat.views.acc_login',name='acc_login'),
    	 url(r'^logout/$', 'wechat.views.logout_view',name='logout'), 

         url(r'^games/$','wechat.views.games',name='games'),
]
