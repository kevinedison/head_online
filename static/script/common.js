...
function(bt) {
	bt.URL = {
		root: "http://www.itcastcpp.cn/",
		getMoreGame: function() {
			bt.dc("more");
			return "http://www.itcastcpp.cn/games"
		},
		getConcern: function() {
			return "http://mp.weixin.qq.com/s?__biz=MzAxMTAwODg2OA==&mid=200679476&idx=1&sn=6f4347d8397a763f9f8a3d0bd5e3735e#rd"
		},
		appId: ""
	};
...
function(bt) {
	function ask(b) {
		if (confirm('关注"火爆朋友嚿微信，就可以收藏这个游戏哦！')) {
...
function(bt) {
	...
	var c = {
		width: "66",
		src: "http://game.id87.com/Public/daoguo/icon.png",
		url: "http://game.id87.com/Public/daoguo",
